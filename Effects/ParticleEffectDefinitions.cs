            ...
            return new Dictionary<EParticleType, SEffectDefinition>()
            {
...

                {
                    ...
                    new SEffectDefinition()
                    {
                        ...
                        Visual = CParticleEffectManager.Dot,
                        Position = Vector2.Zero,
                        PositionVariationCircle = new Vector2(15.0f, 15.0f),
                        PositionVariationBox = Vector2.Zero,
                        PositionDelta = Vector2.Zero,
                        PositionDeltaVariation = new Vector2(0.0f, 0.0f),
                        Scale = new Vector2(0.2f, 0.2f),
                        ScaleVariation = new Vector2(0.0f, 0.0f),
                ...
                {
                    EParticleType.WeaponPlasmaSplash,
                    new SEffectDefinition()
                    {
                        Type = EParticleType.None,
                        Count = 32,
                        Visual = CParticleEffectManager.Dot,
                        Position = Vector2.Zero,
                        PositionVariationCircle = new Vector2(32.0f, 32.0f),
                        PositionVariationBox = new Vector2(8.0f, 8.0f),
                        PositionDelta = Vector2.Zero,
                        PositionDeltaVariation = new Vector2(0.5f, 0.5f),
                        Scale = new Vector2(0.4f, 0.4f),
                        ScaleVariation = Vector2.Zero,
                ...
                {
                    EParticleType.WeaponBombletHit,
                    new SEffectDefinition()
                    {
                        Type = EParticleType.None,
                        Count = 8,
                ...
                {
                    EParticleType.WeaponBoomerangHit,
                    new SEffectDefinition()
                    {
                        Type = EParticleType.None,
                        Count = 2,
                ...
                {
                    EParticleType.WeaponIneffective,
                    new SEffectDefinition()
                    {
                        Type = EParticleType.None,
                        Count = 4,
...

                {
                    ...
                    new SEffectDefinition()
                    {
                        ...
                        Visual = CParticleEffectManager.Dot,
                        Position = Vector2.Zero,
                        PositionVariationCircle = new Vector2(28.0f, 28.0f),
                        PositionVariationBox = Vector2.Zero,
                        PositionDelta = Vector2.Zero,
                        PositionDeltaVariation = new Vector2(0.4f, 0.4f),
                        Scale = new Vector2(0.3f, 0.3f),
