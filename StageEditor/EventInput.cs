...
namespace EventInput
{
    ...
    {
        private XnaKeys keyCode;

        public KeyEventArgs(XnaKeys keyCode)
        {
            this.keyCode = keyCode;
        }

        public XnaKeys KeyCode
        {
            get { return keyCode; }
        }
    }
    ...
    public class MouseEventArgs : EventArgs
    {
        ...
        public WinPoint Location { get { return new WinPoint(x, y); } }
    ...
    public static class InputSystem
    {
        ...
        public static WinPoint MouseLocation
        {
            get
            {
                MouseState state = Mouse.GetState();
                return new WinPoint(state.X, state.Y);
            }
        }
        ...
        public static bool ShiftDown
        {
            get
            {
                ...
                return state.IsKeyDown(XnaKeys.LeftShift) || state.IsKeyDown(XnaKeys.RightShift);
            }
        }
        ...
        public static bool CtrlDown
        {
            ...
            {
                KeyboardState state = Keyboard.GetState();
                return state.IsKeyDown(XnaKeys.LeftControl) || state.IsKeyDown(XnaKeys.RightControl);
            }
        }
        ...
        public static bool AltDown
        {
            ...
            {
                KeyboardState state = Keyboard.GetState();
                return state.IsKeyDown(XnaKeys.LeftAlt) || state.IsKeyDown(XnaKeys.RightAlt);
            }
        }
        ...
        public static void Initialize(IntPtr handle)
        {
            ...
            prevWndProc = (IntPtr)SetWindowLong(handle, GWL_WNDPROC, (int)Marshal.GetFunctionPointerForDelegate(hookProcDelegate));
        ...
        static IntPtr HookProc(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            switch (msg)
            {
                ...
                case WM_KEYDOWN:
                    if (KeyDown != null)
                        KeyDown(null, new KeyEventArgs((XnaKeys)wParam));
                    break;

                case WM_KEYUP:
                    if (KeyUp != null)
                        KeyUp(null, new KeyEventArgs((XnaKeys)wParam));
                    break;
