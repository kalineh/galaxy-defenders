...
namespace Galaxy
{
    public class CDebug
    {
        ...
        public void DrawDisk(Vector2 position, float radius)
        {
            ...
            Game.DefaultSpriteBatch.Draw(Game.PixelTexture, center, null, Color.White, 0.0f, Vector2.Zero, scale, SpriteEffects.None, 0.0f);
        }
        ...
        public void DrawVector(Vector2 position, Vector2 vector, float thickness)
        {
            ...
            Game.DefaultSpriteBatch.Draw(Game.PixelTexture, position, null, Color.White, angle, Vector2.Zero, draw_vector, SpriteEffects.None, 0.0f);
        }
    }
}
