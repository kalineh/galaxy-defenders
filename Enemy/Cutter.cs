...
namespace Galaxy
{
        ...
        : CEnemy
    {
        ...
        {
            Vector2 pos = Physics.PositionPhysics.Position;
            Vector2 dir = Vector2.UnitX.Rotate(BeamRotation);
            Vector2 ofs = dir * 116.0f;
            Left.Physics.PositionPhysics.Position = pos + ofs;
            Left.Physics.AnglePhysics.Rotation = BeamRotation * 3.0f;
            Right.Physics.PositionPhysics.Position = pos - ofs;
            Right.Physics.AnglePhysics.Rotation = BeamRotation * -3.0f;
        }

        public override void UpdateCollision()
        {
            CollisionAABB aabb = Collision as CollisionAABB;
            aabb.Position = Physics.PositionPhysics.Position - new Vector2(32.0f, 32.0f);
        }

        public override void Draw(SpriteBatch sprite_batch)
        {
            base.Draw(sprite_batch);
            BeamVisual.Draw(sprite_batch, Physics.PositionPhysics.Position, BeamRotation);
        }
