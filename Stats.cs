...
namespace Galaxy
{
    public class CStats
    {
        ...
        static CStats()
        {
            ...
            AwardDefinitions[AwardType.BronzeMedal] = new SAward { Type = AwardType.BronzeMedal, Text = "Skill Bonus", Bonus = 250 };
            AwardDefinitions[AwardType.SilverMedal] = new SAward { Type = AwardType.SilverMedal, Text = "Skill Bonus", Bonus = 500 };
            AwardDefinitions[AwardType.GoldMedal] = new SAward { Type = AwardType.GoldMedal, Text = "Skill Bonus", Bonus = 1000 };
