...
namespace Galaxy
{
        ...
        : CEntity
    {
            ...
            : base(world, "Asteroid")
        {
            ...
            Visual = new CVisual(CContent.LoadTexture2D(world.Game, "Textures/Entity/Asteroid"), Color.White);
            Cracks = new CVisual(CContent.LoadTexture2D(world.Game, "Textures/Entity/Cracks"), Color.White);
            Cracks.Alpha = 0.0f;
        }
